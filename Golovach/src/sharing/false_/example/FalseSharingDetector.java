package sharing.false_.example;
...
public class FalseSharingDetector {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		final CountDownLatch latch0 = new java.util.concurrent.CountDownLatch(2);
		final CountDownLatch latch2 = new java.util.concurrent.CountDownLatch(2);
